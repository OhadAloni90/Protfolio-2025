...
const BioTemplate = () => {
  ...
  const workingTitles: WorkingTitle[] = [
    {
      ...
      description: "As one of four core developers in a large, distributed SaaS platform for sports clubs, I worked on enhancing fan engagement through customizable activations, social media management, and data analysis tools.",
      active: true
    },
    {
      ...
      description: "Joined the team during the acquisition process to replace a departing developer, quickly adapting to the existing activation and data collection platform. Gained deep familiarity with the codebase while integrating new features and enhancing functionality.",
      active: false
    },
  ];
  ...
  const EducationTitleContainer = (eTitle: EducationTitle) => {
    return (
      <div className="eTitle text" key={eTitle.degree_name}>
    ...
    switch (activeTab) {
      case "Me":
        return (
          <>
            <p>
              I am a multidisciplinary developer and designer with a background in
              architecture, UX, and computer science. With a deep passion for user-focused
              design and seamless UI/UX, I blend aesthetic precision with technical expertise to
              create engaging digital experiences.
            </p>
            <p>
              My architectural training enhances my structured thinking, allowing me to collaborate
              effectively with product teams and ensure thoughtful, user-centric solutions.
            </p>
      ...
      case "Education":
        return (
          <>
            <p>
              I studied Architecture and Computer Science at XYZ University. During my studies, I
              developed a passion for generative design and interactive media, leading me to blend
              art with technology in innovative ways.
            </p>
            <p>
              I have also attended various workshops and bootcamps to refine my skills in both
      ...
      case "Work Experience":
        return (
          <>
            <p>
              Back in the days, my work experience ranged from designing building layouts to developing
              responsive web applications. Today, I am a full time frontend developer.
            </p>
            <p>
              I have collaborated on projects that combine creative design with cutting-edge
              technology, delivering engaging experiences that are both visually appealing and
              highly functional.
            </p>
            {workingTitles.map((educationTitle: EducationTitle) =>
                  EducationTitleContainer(educationTitle)
                )}
